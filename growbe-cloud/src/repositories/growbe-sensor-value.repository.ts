...
import {GrowbeSensorValue, GrowbeSensorValueRelations, GrowbeMainboard} from '../models';
...
> {
  ...
  public readonly growbeMainboard: BelongsToAccessor<GrowbeMainboard, typeof GrowbeSensorValue.prototype.id>;

  constructor(
    @inject('datasources.mongo') dataSource: MongoDataSource, @repository.getter('GrowbeMainboardRepository') protected growbeMainboardRepositoryGetter: Getter<GrowbeMainboardRepository>,
  ) {
