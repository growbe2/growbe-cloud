...
export type DataSubjectFunc = (id: string, service: any, data: any, topic: string) => Promise<any>;
export type DataModuleFunc = (id: string, moduleId: string, service: any, data: any, topic?: string) => Promise<any>
...
export function funcModuleSubject(
  func: DataModuleFunc,
): DataSubjectFunc {
