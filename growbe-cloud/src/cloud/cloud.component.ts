...
import {GrowbeStreamComponent, GrowbeStreamRepository, NMSBindings} from '../component';
...
export class CloudComponent implements Component {
  ...
  constructor(
    @inject(CoreBindings.APPLICATION_INSTANCE) app: RestApplication & ApplicationWithRepositories
  ) {
