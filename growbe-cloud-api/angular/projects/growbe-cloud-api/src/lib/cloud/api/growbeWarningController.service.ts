...
export class GrowbeWarningControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public growbeWarningControllerFindById(id: number, filter?: GrowbeWarningFilter, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<GrowbeWarningWithRelations>;
    public growbeWarningControllerFindById(id: number, filter?: GrowbeWarningFilter, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<GrowbeWarningWithRelations>>;
    public growbeWarningControllerFindById(id: number, filter?: GrowbeWarningFilter, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<GrowbeWarningWithRelations>>;
    public growbeWarningControllerFindById(id: number, filter?: GrowbeWarningFilter, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (id === null || id === undefined) {
